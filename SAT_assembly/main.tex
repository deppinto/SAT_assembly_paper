...
\noindent
\emph{2. Decreasing the symmetry of the building block increases the yield}. While for $\gamma=60^\circ$ the particles have a five-fold symmetry axis, altering the $\gamma$ angle breaks the rotational symmetry and divides the patches in three \emph{geometrical sets} of interacting patches:
the first one for
