...
\noindent where $X_\alpha$ is the probability that patch $\alpha$ is non-bounded, and computed through Eq.~\ref{prob}. It can be proven that the mean-field and Wertheim predictions coincide in the limit of high-temperatures~\cite{Russo2020}.
